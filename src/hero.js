const slides = [
 ...
 {image:'hero-security-modern.jpg',alt:'Modern dome security camera on a glass-fronted building',label:'CCTV & security',title:'Keep an eye on<br>what matters.',accent:'Wherever you are.',copy:'Plan your camera coverage, recording, and mobile viewing with equipment and installation tailored to your property.',link:'#services',cta:'Explore security',name:'Smarter security'},
...
export function mountHero(){
 ...
 function start(){
  clearInterval(timer);
  if(!document.hidden)timer=setInterval(showNext,7000);
 }
